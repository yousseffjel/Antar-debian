...
nala install feh kitty rofi picom thunar polkit-kde-agent-1 x11-xserver-utils xorg xbacklight xbindkeys xvkbd xinput xorg-dev unzip wget pulseaudio pavucontrol build-essential libx11-dev libxft-dev libxinerama-dev -y
